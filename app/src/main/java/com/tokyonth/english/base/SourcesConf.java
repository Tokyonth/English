package com.tokyonth.english.base;

import com.tokyonth.english.R;

public class SourcesConf {

    public static String[] str_zh = {"苹果","婴儿","狗","妈妈","火车","老师"};
    public static String[] imgUrls = new String[]{"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1556094759217&di=943686daea0415763a8364d3ac0d8233&imgtype=0&src=http%3A%2F%2Fi0.hdslb.com%2Fbfs%2Farticle%2Fe7abe6079c12527f838195f6b0de9c88bdb0b6cb.jpg"
    ...
    // public static String[] str_en = {"apple","baby","dog","mother","train","teacher"};
    //public static int[] img = {R.drawable.pg,R.drawable.ye,R.drawable.dog,R.drawable.mm,R.drawable.hc,R.drawable.ls};
